...
#ifdef VENDOR_EDIT
/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2020/03/16, Add for multi-project speaker PA*/
static u32 oppo_spk_id = 0;
#endif /* VENDOR_EDIT */
...
static struct wcd_mbhc_config wcd_mbhc_cfg = {
	...
	#ifndef VENDOR_EDIT
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.HeadsetDet, 2019/08/31, Modify for disable moisture detect*/
...
#ifdef VENDOR_EDIT
/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2020/03/16, Add for multi-project speaker PA*/
static char const *spk_product_id_text[] = {
	"SPK_NONE", "SPK_TFA9874_MONO", "SPK_TFA9874_STEREO",
	"SPK_MAX989XX_MONO", "SPK_MAX989XX_STEREO"
};

static const struct soc_enum spk_product_id_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(spk_product_id_text), spk_product_id_text),
};

static int oppo_spk_product_id_get(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
	pr_info("%s: get speaker product id %d\n", __func__, oppo_spk_id);
	ucontrol->value.integer.value[0] = oppo_spk_id;

	return 0;
}

static int oppo_spk_product_id_set(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}
...
static const struct snd_kcontrol_new msm_mi2s_snd_controls[] = {
	...
	#ifdef VENDOR_EDIT
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2020/03/16, Add for multi-project speaker PA*/
	SOC_ENUM_EXT("OPPO_SPK_ID", spk_product_id_enum[0],
			oppo_spk_product_id_get,
			oppo_spk_product_id_set),
	#endif /* VENDOR_EDIT */
};
...
static struct snd_soc_dai_link msm_wsa_cdc_dma_be_dai_links[] = {
	/* WSA CDC DMA Backend DAI Links */
	{
		...
		.dpcm_playback = 1,
		#ifndef VENDOR_EDIT
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2019/07/03, Delete for disable wsa*/
...
static struct snd_soc_dai_link msm_va_cdc_dma_be_dai_links[] = {
	{
		...
		.dpcm_capture = 1,
		#ifdef VENDOR_EDIT
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2019/07/03, Add for audrx init when disable wsa*/
		.init = &msm_int_audrx_init,
		#endif /* VENDOR_EDIT */
...
static struct snd_soc_card *populate_snd_card_dailinks(struct device *dev)
{
	...
	u32 wcn_btfm_intf = 0;
	#ifdef VENDOR_EDIT
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2019/07/03, Add for disable wsa*/
	...
	if (!strcmp(match->data, "codec")) {
		...
		#ifndef VENDOR_EDIT
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2019/07/03, Modify for disable wsa*/
		memcpy(msm_kona_dai_links + total_links,
...
static int msm_asoc_machine_probe(struct platform_device *pdev)
{
	...
	ret = of_property_read_u32(card->dev->of_node,
				"oppo,speaker-product-id", &oppo_spk_id);
	if (ret) {
		pr_info("%s: missing speaker-product-id in dt node\n", __func__);
	} else {
		pr_info("%s: oppo speaker-product-id %d\n", __func__, oppo_spk_id);
	}
	#endif /* VENDOR_EDIT */
