...
#ifndef VENDOR_EDIT
/* Jianfeng.Qiu@PSW.MM.AudioDriver.HeadsetDet, 2020/03/09, Modify for close qcom impedance detect */
					  ...
					  bool enable)
{
	if (enable) {
		...
		#ifndef VENDOR_EDIT
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.HeadsetDet.2430813, 2020/03/13,
		 Delete for not set L/R 100K, avoid plug in noise.
		 */
		snd_soc_update_bits(codec, WCD937X_HPH_PA_CTL2,
				    0x40, 0x00);
		snd_soc_update_bits(codec, WCD937X_HPH_PA_CTL2,
