...
#ifdef VENDOR_EDIT
// Liujie.Xie@TECH.Kernel.Sched, 2020/04/29, add for improving animation issue
static void drop_ux_task_cpus(struct task_struct *p, struct cpumask *lowest_mask)
{
	unsigned int cpu = cpumask_first(lowest_mask);
