...
#ifdef VENDOR_EDIT
//Cong.Dai@BSP.TP.Function 2020/03/10 add for get rtc alarm set info
	pr_err("----------qpnp_rtc set alarm secs=%ld  secs_rtc=%ld diff=%ld\n",secs, secs_rtc, secs - secs_rtc);
#endif
...
//Cong.Dai@BSP.TP.Function 2020/03/10 add for get rtc alarm set info
	...
	pr_err("----------%s qpnp_rtc secs_alarm is %lu, secs_rtc is %lu\n", __func__, secs_alarm, secs_rtc);
#endif
