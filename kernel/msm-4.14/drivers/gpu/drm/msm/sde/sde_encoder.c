...
#ifdef VENDOR_EDIT
	/*Mark.Yao@PSW.MM.Display.LCD.Stable,2019-12-09 fix input_handler register/unregister */
...
extern int sde_connector_update_backlight(struct drm_connector *connector, bool post);
